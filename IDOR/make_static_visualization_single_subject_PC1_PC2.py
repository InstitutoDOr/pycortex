...
for s in ss:
    ...
    print sid
    dv1 = cortex.Volume('/home/brain/pycortex/IDOR/images/RESULTS/S' +str(s) + '/train_corr.nii.gz', subject, 'fullhead', description='CORR',  cvthr=0.01, cmap=cm, vmin=0.05, vmax=0.4, interp="trilinear", stim='/data/devel/pycortex_ntt/filestore/colormaps/autumn_blkmin_alpha_2D.png')
    ds.append(CORR=dv1)
    ...
    for idx, fn in enumerate(feature_names):
        ...
        dv01 = cortex.Volume('/home/brain/pycortex/IDOR/images/RESULTS/S' +str(s) + '/W_mean_'+iidx+'.nii.gz', subject, 'fullhead', description=fn,  cmap='jet_alpha0', vmin=-0.1, vmax=0.1, priority=idx+1)
        kwargs = {fn: dv01}
        ds.append(**kwargs)
        #print fn
