...
#fdir = '/media/sf_Z/Dropbox/Doutorado/MusicalEncodingPaperDraft/PYCORTEX_FIGURES/pycortex_static_visualization/'
...
si = 0
for f in fs:
    filename = fdir + 'mean_on_S1' + f + '.png'
    ...
    for lr in [0,1]:
        ...
        cutout = im.crop(bbox)
        #cutout.show()
        cutout.save(fdirout + 'patch' + 'mean_on_S1' + f + lrn[lr] + '.png')
